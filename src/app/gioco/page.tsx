    ...
    <PageShell>
        ...
        <div className="space-y-8">
          ...
          {mode === "vscomputer" && (
            <div className="glass rounded-2xl p-5">
              <p className="mb-4 text-sm font-medium text-[var(--foreground)]">Impostazioni computer</p>
              <DifficultySelector
      ...
      {step === "setup" && mode && (
        <div className="space-y-8">
          {mode === "singleplayer" && (
            <div className="glass rounded-2xl p-5">
              <p className="mb-3 text-sm font-medium text-[var(--foreground)]">Partiti reali in gara</p>
            ...
            <div className="space-y-3">
              ...
              {players.map((p) => (
                <div key={p.id} className="glass rounded-xl p-3 text-sm">
                  <span className="font-semibold text-[var(--foreground)]">{p.displayName}</span>
        ...
        <div className="space-y-6">
          ...
          {players.map((p) => (
            <div key={p.id} className="glass rounded-2xl p-4">
              <p className="font-semibold text-[var(--foreground)]">{p.displayName}</p>
        ...
        <div className="space-y-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {result.players.map((p) => (
              ...
              >
                <p className="font-semibold text-[var(--foreground)]">{p.displayName}</p>
                <p className="font-mono-data text-2xl text-[var(--foreground)]">{p.percentage}%</p>
          ...
          <div className="glass rounded-2xl p-5">
            <h3 className="font-semibold text-[var(--foreground)]">Analisi narrativa</h3>
