...
export const CURATED_PUBLIC_FIGURES: (Seed & { aliases?: string[] })[] = [
  ...
  },
  {
    ...
    category: "NATIONAL_PUBLIC",
    biography:
      "Generale dell'Arma dei Carabinieri ed europarlamentatore. Fondatore e presidente di Futuro Nazionale dal 6 febbraio 2026, dopo aver lasciato la Lega il 3 febbraio 2026. Ex vicesegretario della Lega (2025-2026). Posizioni nazionaliste, sovraniste ed euroscettiche; autore de Il mondo al contrario.",
    politicalHistory: [
      ...
      "Generale dell'Arma dei Carabinieri (ex)",
    ],
    positions: ["Presidente Futuro Nazionale", "Europarlamentare", "Generale (ex)"],
    partyHistory: ["Futuro Nazionale", "Lega (abbandonata nel 2026)"],
    mediaExposure: 78,
    publicRecognition: 74,
    defaultPartySlug: "futuro-nazionale",
    incompatiblePartySlugs: ["lega"],
    ideologyHint: 0.75,
    controversies: {
      verifiedFacts: [
        "Presidente di Futuro Nazionale (statuto registrato febbraio 2026).",
        "Ha lasciato la Lega nel febbraio 2026 per fondare Futuro Nazionale.",
        "Europarlamentare; ex vicesegretario della Lega.",
        "Carriera militare nell'Arma dei Carabinieri.",
      ],
      proceedings: [],
      finalConvictions: [],
      accusations: [],
      publicOpinions: [
        "Figura polarizzante per posizioni su immigrazione, Europa e identità.",
      ],
    },
    sources: [
      { title: "Futuro Nazionale", type: "partito" },
      { title: "Parlamento europeo", type: "istituzionale" },
